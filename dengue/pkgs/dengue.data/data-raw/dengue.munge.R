# Read in raw data
dengue.features.train <- 
  read.csv("~/Documents/Data_Science_Learning/CompSci415.1/CSX415.1-project/dengue/pkgs/dengue.data/data-raw/dengue_features_train.csv", header = TRUE)
dengue.labels.train <- 
  read.csv("~/Documents/Data_Science_Learning/CompSci415.1/CSX415.1-project/dengue/pkgs/dengue.data/data-raw/dengue_labels_train.csv", header = TRUE)
hotel.guests.copy <- 
  read.csv("~/Documents/Data_Science_Learning/CompSci415.1/CSX415.1-project/dengue/pkgs/dengue.data/data-raw/hotel_guests_copy.csv", header = TRUE)
...
# Add processed data to package
devtools::use_data(dengue.sj, 
                   pkg = "~/Documents/Data_Science_Learning/CompSci415.1/CSX415.1-project/dengue/pkgs/dengue.data",
                   overwrite = TRUE)
devtools::use_data(dengue.med, 
                   pkg = "~/Documents/Data_Science_Learning/CompSci415.1/CSX415.1-project/dengue/pkgs/dengue.data",
                   overwrite = TRUE)
devtools::use_data(dengue.knn, 
                   pkg = "~/Documents/Data_Science_Learning/CompSci415.1/CSX415.1-project/dengue/pkgs/dengue.data",
                   overwrite = TRUE)
