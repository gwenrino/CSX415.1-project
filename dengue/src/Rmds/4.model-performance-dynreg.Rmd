...
Experimentation with these five variables revealed that an ARIMA(1,1,1) model with `reanalysis_dew_point_temp_k` as the regressor was the best (see `dengue/src/Models/4.DynamicRegression.R`). The model takes the form:  

```{r}

source("~./src/LoadData/Load.R") # HELP
source("~./src/Munge/Munge.r") # HELP
source("~./src/Models/4.DynamicRegression.R") # HELP
source("~./src/Models/5.DynRegValidation.R") # HELP
