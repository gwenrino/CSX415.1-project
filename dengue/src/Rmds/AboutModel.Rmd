...
It should be emphasized that the forecasting tool gives much more dependable results for near-future predictions than long-term ones; the uncertainty rises for longer time horizons. (For more information about the accuracy of the model at different time horizons, please see the document 4.DynRegEval.pdf, which can be found at dengue/reports/ModelEvaluations/4.DynRegEval.pdf)
