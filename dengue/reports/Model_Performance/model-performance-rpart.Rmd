...
This decision tree model uses all the variables except week_start_date, which is the unique identifier, and year. It includes the engineered feature year.season.
